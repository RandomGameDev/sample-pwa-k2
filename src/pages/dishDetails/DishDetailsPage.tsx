...
export const DishDetailsPage = () => {
  ...
  return (
    <div className={cn("px-0 py-6")}>
      <img src={landing1} alt="" className="w-full" />
      <div className={cn("px-4 py-2")}>
        <div className="my-4 flex items-end justify-between">
          <h1 className="text-4xl">Premium Soy Garlic Karaage</h1>
          <span className="text-4xl">₱ 249.00</span>
        </div>
        ...
        {addons.map((addon) => (
          <div
            key={addon.id}
            className={cn("addons-center my-2 flex justify-between")}
          >
            <div className={cn("addons-center flex justify-between gap-2")}>
              <div className={cn("flex items-center gap-4")}>
                <input type="checkbox" className={cn("h-4 w-4")} />
                <span className={cn("text-lg")}>{addon.name}</span>
              </div>
            </div>
      ...
      <hr className="border-6 border-e-neutral-500 border-b-neutral-200" />
      <div className={cn("px-4 py-2")}>
        ...
        <textarea
          ...
          placeholder="Please remove onions if there any."
        />
      </div>
      ...
      <div className={cn("px-4 py-2")}>
        <Button className="border-primary-500 bg-primary-500 mt-4 w-full rounded-lg border-2 py-6 text-2xl text-black">
          Add to Basket - ₱ 249.00
        </Button>
      </div>
    </div>
  );
